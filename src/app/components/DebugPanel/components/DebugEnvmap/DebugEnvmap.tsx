...
export const DebugEnvmap = ({
  ...
  return (
    <div>
      ...
      {/* アコーディオンヘッダー */}
      <button
        className={`${debugPanelStyles.accordionHeader} ${activeAccordion === 'envmap' ? debugPanelStyles.accordionActive : ''}`}
        onClick={() => setActiveAccordion(activeAccordion === 'envmap' ? '' : 'envmap')}
      >
        環境テクスチャの変更
